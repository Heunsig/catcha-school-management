<template>
  <v-dialog v-model="is_active" persistent scrollable max-width="1100">
    <v-card>
      <v-card-title>
        <h4 class="ca-typo-title-4">Issue Receipt</h4>
        <v-spacer></v-spacer>
        <div>
          <strong>Total:</strong>
...
import PaymentInformationForm from './addition_form/PaymentInformationForm'
import InvoiceItemForm from './addition_form/InvoiceItemForm'
